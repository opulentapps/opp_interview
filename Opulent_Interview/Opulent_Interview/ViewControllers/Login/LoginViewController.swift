...
class LoginViewController: UIViewController {
    ...
    @IBOutlet weak var tfSignUpName: OpAppTextField!
    @IBOutlet weak var tfSignUpEmail: OpAppTextField!
    @IBOutlet weak var tfSignUpPass: OpAppTextField!
    @IBOutlet weak var tfSignUpRePass: OpAppTextField!
    ...
    @IBOutlet weak var tfSignInEmail: OpAppTextField!
    @IBOutlet weak var tfSignInPass: OpAppTextField!
...
//        manager.logOut()
//        manager.logIn(withReadPermissions: ["email"], from: self, handler: {(result: FBSDKLoginManagerLoginResult?, error: Error?) in
...
//                Global.appDelegate.firebaseLoginWith(credential: credential, info: SignInInfo.makeFacebook(accessToken: FBSDKAccessToken.current().tokenString))
//            }
//            else {
